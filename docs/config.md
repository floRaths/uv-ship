...
### `date-first`
_string_  : <span class="acc-2-code">`false`</span>

Whether to place the date in the changelog header before the tag or not.
> _default:_ v0.7.0 — [2025-10-21]  
> _date-first:_ [2025-10-21] — v0.7.0  
